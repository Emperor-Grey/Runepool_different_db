use crate::config::connect::LEVEL_DB;
...
pub async fn get_runepool_units_history_from_leveldb(
    ...
    match get_runepool_units_history_leveldb(
        db,
        limit,
        offset,
